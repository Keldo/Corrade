...
namespace Corrade
{
    public partial class Corrade
    {
        ...
        {
            public static readonly Action<Command.CorradeCommandParameters, Dictionary<string, string>> crouch =
                (corradeCommandParameters, result) =>
                {
                    ...
                    switch (action)
                    {
                        ...
                        case Enumerations.Action.STOP:
                            ...
                            lock (Locks.ClientInstanceSelfLock)
                            {
                                Client.Self.Crouch(action.Equals(Enumerations.Action.START));
                            }
                            break;
                        default:
