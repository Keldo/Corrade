...
namespace Corrade
{
    public partial class Corrade
    {
        ...
        {
            public static readonly Action<Command.CorradeCommandParameters, Dictionary<string, string>> parcelfreeze =
                (corradeCommandParameters, result) =>
                {
                    ...
                    if (
                        !bool.TryParse(
                            wasInput(
                                KeyValue.Get(
                                    wasOutput(Reflection.GetNameFromEnumValue(Command.ScriptKeys.FREEZE)),
                                    corradeCommandParameters.Message)),
                            out freeze))
                    {
                        freeze = false;
