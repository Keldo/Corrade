...
namespace Corrade
{
    public partial class Corrade
    {
        ...
        {
            public static readonly Action<Command.CorradeCommandParameters, Dictionary<string, string>> createtree =
                (corradeCommandParameters, result) =>
                {
                    ...
                    if (
                        !bool.TryParse(
                            wasInput(
                                KeyValue.Get(wasOutput(Reflection.GetNameFromEnumValue(Command.ScriptKeys.NEW)),
                                    corradeCommandParameters.Message)),
                            out newTree))
                    {
                        newTree = true;
                    ...
                    {
                        throw new Command.ScriptException(Enumerations.ScriptError.UNKNOWN_TREE_TYPE);
                    }
